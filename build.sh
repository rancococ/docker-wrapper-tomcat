...
# images
images=(
wrapper-tomcat:1.0.0-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-tomcat:1.0-centos
wrapper-tomcat:1.0.0-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-tomcat:1.0.0-centos
)
